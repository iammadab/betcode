...
function connectToOnlineDb(mongoose){
	let uri = `mongodb://madab:${process.env.DBPASS}@cluster0-shard-00-00.fsdff.mongodb.net:27017,cluster0-shard-00-01.fsdff.mongodb.net:27017,cluster0-shard-00-02.fsdff.mongodb.net:27017/bookmakr?ssl=true&replicaSet=atlas-l2dk1c-shard-0&authSource=admin&retryWrites=true&w=majority`
